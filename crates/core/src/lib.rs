...
pub use domain::{
    AffectedReason, AffectedReport, AffectedRequest, AiContext, AiContextRequest,
    BoundaryLintReport, BoundaryLintRequest, CiMatrixReport, CiMatrixRequest, CodegenCheckReport,
    CodegenCheckRequest, CommandSpec, DependencySurface, DependencyTarget, DeploySpec,
    DiscoverRequest, EdgeKind, ExplainReport, ExplainRequest, FileOperation, GeneratedCodePolicy,
    GraphEdge, GraphNode, GraphNodeKind, GraphPrintReport, GraphPrintRequest, GraphValidateRequest,
    IacFacadeReport, IacFacadeRequest, IacProvider, IacSpec, InitPlan, InitProfile, InitRequest,
    NewProjectRequest, OwnerHandle, PolicyMode, PrSummary, PrSummaryRequest, ProcessCommand,
    ProcessOutput, ProjectAiSpec, ProjectAreas, ProjectDependency, ProjectKind, ProjectManifest,
    ...
    SchemaId, SkillsFacadeReport, SkillsFacadeRequest, TaskCommand, TaskCommandOutput, TaskName,
    TaskRunPlan, TaskRunReport, TaskRunRequest, TemplateFile, TemplateInput, TemplateListReport,
    TemplateListRequest, TemplateManifest, TemplateRenderRequest, TemplateSource, TemplateSummary,
    Visibility, WorkspaceLanguage, WorkspaceName, WorkspaceSpec, utf8_path_buf,
