...
pub use domain::{
    ...
    BoundaryLintReport, BoundaryLintRequest, CiMatrixReport, CiMatrixRequest, CommandSpec,
    DependencySurface, DependencyTarget, DeploySpec, DiscoverRequest, EdgeKind, ExplainReport,
    ExplainRequest, FileOperation, GeneratedCodePolicy, GraphEdge, GraphNode, GraphNodeKind,
    GraphPrintReport, GraphPrintRequest, GraphValidateRequest, IacFacadeReport, IacFacadeRequest,
    ...
    ProjectAreas, ProjectDependency, ProjectKind, ProjectManifest, ProjectName, ProjectProtoSpec,
    ...
    RepoRoot, RepoSnapshot, ResolvedTemplateSource, SchemaId, SkillsFacadeReport,
    SkillsFacadeRequest, TaskCommand, TaskCommandOutput, TaskName, TaskRunPlan, TaskRunReport,
    TaskRunRequest, TemplateFile, TemplateInput, TemplateManifest, TemplateSource, Visibility,
    WorkspaceLanguage, WorkspaceName, WorkspaceSpec, utf8_path_buf, validate_project_convention,
};
