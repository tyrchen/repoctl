...
crates/repoctl-runner/     affected analysis, task planning, CI, proto, IaC
...
- `repoctl-runner` computes affected work, plans or runs tasks, builds CI data, checks codegen policy, resolves proto ownership, builds PR summaries, and plans IaC commands.
